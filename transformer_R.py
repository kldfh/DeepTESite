...
negative_training_set_txt = pd.read_csv('dataset/R_data/R_negative_train_set(35809).txt', sep="\t", header=None)
print(f'读取的负样本训练集1数据：\n{negative_training_set_txt}')
positive_training_set_txt = pd.read_csv('dataset/R_data/R_positive_train_set(35809).txt', sep="\t", header=None)
negative_test_set_txt = pd.read_csv('dataset/R_data/R_negative_test_set(1280).txt', sep="\t", header=None)
print(f'读取的负样本训练集1数据：\n{negative_training_set_txt}')
positive_test_set_txt = pd.read_csv('dataset/R_data/R_positive_test_set(1280).txt', sep="\t", header=None)
...
start_w = 20 - int(window / 2)
end_w = 20 + int(window / 2) + 1
...
dataset_X_token = dataset_X_token.reshape(len(dataset_X), 41)
...
dataset_X_token_test = dataset_X_token_test.reshape(len(dataset_X_test), 41)
